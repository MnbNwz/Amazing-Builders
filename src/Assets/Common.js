let Common = {
    ...
    aboutUs: "About Us",
    aboutUsText1: "Founded by two partners who had different skills and experiences but a shared vision and entrepreneurial spirit, Matrix Designer Builders is a rising Australian home builder with a wide array of experience in residential housing.",
    aboutUsText2: "In an industry being filled with companies that simply reproduce more and more variants of the same house – as if each fell from a giant cookie-cutter. Few bother to challenge the status quo or alter the norm. Building a home should be an exciting and personal journey and the finished product a symbol of pride. This is why Matrix specialise in custom homes guiding clients through this personal journey.",
    aboutUsText3: "In partnership with our valued trades and suppliers, we pride ourselves on delivering quality homes in communities where our customers want to live.",
    recentProjects: "RECENT PROJECTS",
    recentProjectsArray: [
    ...
    contact: "CONTACT",
    inquiry: "Inquiries",
    inquiryText: "For any inquiries, questions or commendations, please call: 0418 708 559 or fill out the following form",
    ...
    exmpoymenetText: "To apply for a job with Matrix Designer Builds, please send a cover letter together with your C.V. to: info@matrixdesignerbuilders.com.au",
    getA_Qoute: "Get a quote: 0418-708-559",
    socialMedia: "Socials/Media",
    copywriteText: "by Matrix Designer Builders.",
